...
{
  public:
    problem_size (int user_n_phis, int user_n_scenario, int user_n_times, int user_n_reactions, double user_oxidizer, double user_nitrogen, double user_fuel, bool user_heat_rates, bool user_init_temperatures, double user_heating_rate, double user_TO, double user_time_ig, double user_Tig);
